    ...
    collections: [
      {
        ...
        fields: [
          ...
          { type: "string", name: "hero_title_2", label: "Title Line 2 (accent)" },
          { type: "string", name: "hero_title_3", label: "Title Line 3" },
          { type: "string", name: "hero_desc", label: "Description", ui: { component: "textarea" } },
          { type: "string", name: "hero_cta_offer", label: "CTA: Offer Button" },
          { type: "string", name: "hero_cta_services", label: "CTA: Services Button" },
      ...
      },
      {
        ...
        fields: [
          ...
          { type: "string", name: "about_story_p1", label: "Story Paragraph 1" },
          { type: "string", name: "about_story_p2", label: "Story Paragraph 2", ui: { component: "textarea" } },
        ...
        fields: [
          ...
          { type: "string", name: "service_cta", label: "CTA Button" },
          {
            ...
            fields: [
              ...
              { type: "string", name: "desc", label: "Descriere", ui: { component: "textarea" } },
              { type: "boolean", name: "hidden", label: "Ascunde acest element" },
            ],
          },
      ...
      },
      {
        ...
        fields: [
          ...
          { type: "string", name: "process_1_desc", label: "Step 1 Description", ui: { component: "textarea" } },
          { type: "string", name: "process_2_title", label: "Step 2 Title" },
          { type: "string", name: "process_2_desc", label: "Step 2 Description", ui: { component: "textarea" } },
          { type: "string", name: "process_3_title", label: "Step 3 Title" },
          { type: "string", name: "process_3_desc", label: "Step 3 Description", ui: { component: "textarea" } },
          { type: "string", name: "process_4_title", label: "Step 4 Title" },
          { type: "string", name: "process_4_desc", label: "Step 4 Description", ui: { component: "textarea" } },
        ],
      },
      {
        name: "avantaje",
      ...
      },
      {
        ...
        fields: [
          ...
          { type: "string", name: "testim_sub", label: "Testimoniale Subtitle" },
          ...
          { type: "string", name: "cta_desc", label: "CTA Description", ui: { component: "textarea" } },
      ...
      },
      {
        ...
        fields: [
          ...
          { type: "string", name: "contact_address_label", label: "Address Label" },
          { type: "string", name: "contact_address_text", label: "Address Text" },
          { type: "string", name: "contact_email_label", label: "Email Label" },
          { type: "string", name: "contact_phone_label", label: "Phone Label" },
          { type: "string", name: "contact_schedule_label", label: "Schedule Label" },
          { type: "string", name: "contact_schedule_text", label: "Schedule Text" },
          ...
          { type: "string", name: "form_service_label", label: "Form: Service Label" },
          ...
          { type: "string", name: "footer_services_heading", label: "Footer: Services Heading" },
          { type: "string", name: "footer_company_heading", label: "Footer: Company Heading" },
          { type: "string", name: "footer_quick_contact", label: "Footer: Quick Contact Heading" },
          { type: "string", name: "footer_copyright", label: "Footer: Copyright Text" },
        ],
      },
    ],
  },
