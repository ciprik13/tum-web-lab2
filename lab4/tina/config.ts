    ...
    collections: [
      {
        ...
        fields: [
          ...
          { type: "string", name: "about_badge", label: "About Badge" },
          { type: "string", name: "about_title", label: "About Title" },
          { type: "string", name: "about_sub", label: "About Subtitle" },
          { type: "string", name: "about_story_title", label: "About Story Title" },
          { type: "string", name: "about_story_p1", label: "About Story Paragraph 1" },
          { type: "string", name: "about_story_p2", label: "About Story Paragraph 2", ui: { component: "textarea" } },
          { type: "string", name: "about_feat_1", label: "About Feature 1" },
          { type: "string", name: "about_feat_2", label: "About Feature 2" },
          { type: "string", name: "about_feat_3", label: "About Feature 3" },
          { type: "string", name: "feature_box_1_title", label: "Feature Box 1 Title" },
          { type: "string", name: "feature_box_1_desc", label: "Feature Box 1 Description" },
          { type: "string", name: "feature_box_2_title", label: "Feature Box 2 Title" },
          { type: "string", name: "feature_box_2_desc", label: "Feature Box 2 Description" },
        ],
      },
    ],
  },
